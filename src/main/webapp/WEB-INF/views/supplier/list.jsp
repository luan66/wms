...
<head>
    ...
    <title>叩丁狼教育PSS（演示版）-供应商管理</title>
    <style>
        .alt td {
...
<body>
<form id="searchForm" action="/supplier/query.do" method="post">
    <div id="container">
                ...
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <c:forEach items="${result.data}" var="d">
                        <tr>
                            ...
                            <td>${d.address}</td>
                            <td>
                                <a href="/supplier/input.do?id=${d.id}">编辑</a>
                                <a href="javascript:;" data-id="${d.id}" class="btn_delete"
                                   data-url="/supplier/delete.do?id="
                                >删除</a>
                            </td>
                        </tr>
                    </c:forEach>
